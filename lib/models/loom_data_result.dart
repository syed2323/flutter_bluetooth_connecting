class LoomDataResult {
  GetLoomDataResult getLoomDataResult;

  LoomDataResult({this.getLoomDataResult});

  LoomDataResult.fromJson(Map<String, dynamic> json) {
    getLoomDataResult = json['Get_LoomDataResult'] != null
        ? new GetLoomDataResult.fromJson(json['Get_LoomDataResult'])
        : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.getLoomDataResult != null) {
      data['Get_LoomDataResult'] = this.getLoomDataResult.toJson();
    }
    return data;
  }
}

class GetLoomDataResult {
  ...
  GetLoomDataResult.fromJson(Map<String, dynamic> json) {
